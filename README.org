...
The focused 0.1 protocol surface is implemented and covered by deterministic transcript tests, PostgreSQL 16 integration tests, and a self-contained real-TLS suite. It is also exercised by [[https://github.com/LuciusChen/clutch/tree/refactor/pgsql][Clutch's pgsql.el integration branch]]. The API remains pre-1.0 and may evolve as additional callers establish concrete requirements.
