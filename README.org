...
[[https://melpa.org/#/pgsql][file:https://melpa.org/packages/pgsql-badge.svg]]
...
=pgsql= is available from [[https://melpa.org/#/pgsql][MELPA]]. After configuring MELPA, install it with =M-x package-install RET pgsql RET=, or declare it with =use-package=:
